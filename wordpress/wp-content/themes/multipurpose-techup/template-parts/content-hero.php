...
?>  
    <!-- ======= Hero Section ======= -->
    <section class="hero-sec beg-img" style="background-image:url(<?php if($techup_banner_image) { echo esc_html($techup_banner_image); } else { echo esc_html(get_header_image()); } ?>)">
      <div class="container">
        <div class="row">
